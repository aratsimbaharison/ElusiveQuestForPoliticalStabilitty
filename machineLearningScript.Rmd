...
### Training and testing a model using cross-validation with the caret package
...
Using cross-validation on the diamonds dataset
...
# Print the summary and the model to console
summary(model)
model
```
