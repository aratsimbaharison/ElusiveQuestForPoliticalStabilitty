...
WGIdevIneqPovDF2 <- left_join(WGIbyCountryAndRegion, devIneqPovDF2, by = c("country", "iso2c", "date"))
...
# cleaning the dataframe WGIdevIneqPovDF by dropping variables and observation in combination with kNN
library(VIM)
summary(WGIdevIneqPovDF)
summary(WGIdevIneqPovDF2)
...
WGIdevIneqPovDF2 <- select(WGIdevIneqPovDF2, country, iso2c, date, stability, stabilityDummy, stabilityCategory, regulatoryQuality, region, subregion, GDPannualGrowthRate, GNIperCapita, devCategory, HDI)
summary(WGIdevIneqPovDF2)
