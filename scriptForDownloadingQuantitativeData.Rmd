...
stabilityDf <- mutate(stabilityDf, 
                      stabilityDummy = if_else(stabilityDf$stability < 0, "0", "1"))
select(country, iso2c, date, stability, stabilityDummy, stabilityCategory)  
head(stabilityDf)
summary(stabilityDf)
...
WGIbyCountryAndRegion <- select(WGIbyCountryAndRegion, country, M49Code, iso2c, iso3c, date, stability, stabilityCategory, corruptionControl, governmentEffectiveness, regulatoryQuality, ruleOfLaw, voiceAndAccountability, region, subregion)
names(WGIbyCountryAndRegion)
...
WGIbyCountryAndRegion <- select(WGIbyCountryAndRegion, country, M49Code, iso2c, iso3c, date, stability, stabilityCategory, regulatoryQuality, region, subregion)
