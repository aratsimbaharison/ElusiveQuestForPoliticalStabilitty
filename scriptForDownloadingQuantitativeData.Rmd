...
# As we collected the data from the World Bank, we realized that the country names and codes were not consistent throughout the database and between the World Bank and other organization.
...
regionSubregionDf$country <- str_replace(regionSubregionDf$country, "Cape Verde", "Cabo Verde")
