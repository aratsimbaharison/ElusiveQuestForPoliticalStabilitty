...
- 1/28/2019:
I think I have finally two clean datasets on WGI, development and poverty:
1) WGIdevIneqPovDF without imputation (2472 observations), available in the folder under `WGIdevIneqPov.csv`
2) WGIdevIneqPovDF2 with imputation (3090 observations), available in the folder under `WGIdevIneqPov2.csv`

I also rerun and clean the data on WGI and regime type and made it available in the local repository, under the file name `WGIregimeTypeByRegion.csv`

- stopped at line 639 "Joining all dataframes on WGI, econimic and social indicators and regime types"
